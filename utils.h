...
{
  aabb res;
  res.upper.x = ::fmaxf(lhs.upper.x, rhs.upper.x);
  res.upper.y = ::fmaxf(lhs.upper.y, rhs.upper.y);
  res.upper.z = ::fmaxf(lhs.upper.z, rhs.upper.z);
  res.lower.x = ::fminf(lhs.lower.x, rhs.lower.x);
  res.lower.y = ::fminf(lhs.lower.y, rhs.lower.y);
  res.lower.z = ::fminf(lhs.lower.z, rhs.lower.z);
  return res;
}
